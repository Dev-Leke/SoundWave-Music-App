...
export default function SettingsScreen() {
  ...
  return (
    <View style={styles.screen}>
      ...
      <Text style={styles.subtitle}>Playback controls and local data.</Text>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.rowValue}>High</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.rowLabel}>Download Over Wi-Fi Only</Text>
          <Switch
            value={repeat}
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.supportingText}>
          Expo React Native demo for college.
        </Text>
      </View>
    </View>
  );
